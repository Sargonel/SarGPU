...
float GetTextFitSize(Font font,const char *text,float fontSize,float spacing,float maxWidth,float maxHeight);
void DrawTextCentered(Font font,const char *text,Rectangle bounds,float fontSize,float spacing,float padding,Color tint);
...
bool IsFileDownloadEnabled(void);
